...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='cifar_model_SAAT_max14_min17/model_199.pth')
    ...
    parser.add_argument('--log_path', type=str, default='cifar_model_SAAT_max14_min17/AA_last.txt')
