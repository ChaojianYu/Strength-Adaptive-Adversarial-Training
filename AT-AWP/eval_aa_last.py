...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='cifar_model_baseline_AWP/model_199.pth')
    ...
    parser.add_argument('--log_path', type=str, default='cifar_model_baseline_AWP/AA_last.txt')
