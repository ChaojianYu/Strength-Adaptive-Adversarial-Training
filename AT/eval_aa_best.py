...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='cifar_model_baseline_AT/model_best.pth')
    ...
    parser.add_argument('--save_dir', type=str, default='cifar_model_baseline_AT')
    parser.add_argument('--batch_size', type=int, default=200)
    parser.add_argument('--log_path', type=str, default='cifar_model_baseline_AT/AA_best.txt')
