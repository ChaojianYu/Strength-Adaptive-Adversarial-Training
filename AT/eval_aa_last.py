...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='cifar_model_baseline_AT/model_199.pth')
    ...
    parser.add_argument('--log_path', type=str, default='cifar_model_baseline_AT/AA_last.txt')
